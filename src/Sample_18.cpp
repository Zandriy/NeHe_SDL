...
void Sample_18::reshape(int width, int height)
{
	// Height / width ration
	GLfloat ratio;
...
bool Sample_18::sendMessage(int message, int mode, int x, int y)
{
	switch (message) {
	case SDLK_l:
		m_light = !m_light;
